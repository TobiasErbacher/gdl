...
We report the results of our experiments with the AP-GCN, Ponder-AP-GCN, RL-AP-GCN, and CoGCN architectures. In \autoref{tab:time-per-epoch}, we report the average training time per epoch for each model architecture. TODO: comment it 
